...
export default function Home() {
  ...
  function buildPanelText(items: SelectedItem[], giverName: string, giverBirthdate: string, discount: 0 | 5 | 10 = 0): string {
    ...
    const totalLine = displayedItems.length > 0
      ? [discount > 0
      ...
      {openTransferPanelId && (() => {
        ...
        return (
          ...
          >
            <div
              onClick={(e) => e.stopPropagation()}
              style={{ width: "min(1000px, 96vw)", maxHeight: "120vh", overflowY: "auto", background: C.bg, borderRadius: 18, boxShadow: "0 24px 64px rgba(0,0,0,0.35)", padding: 24 }}
            >
